...
def simulate_system_cli(system_file, sim_par_json, folder, log_file):
    ...
    """
    try:
        simulate_system(system_file, sim_par_json, folder, log_file)
...
def simulate_system(system_file, sim_par_json=None, folder=None, log_file=None):
    """Simulate an URBANopt DES system in EnergyPlus.
